        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Tambah Surat keluar</h1>
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            ...
                            <div class="card card-primary shadow-none">
                                <form action="{{ route('admin.surat_keluar.store') }}" method="POST">
                                    @csrf
                                    <!-- Form fields -->
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="select2" name="tujuan[]" multiple="multiple"
                                                        ...
                                                        @foreach ($jabatans as $jabatan)
                                                            <option value="{{ $jabatan->id }}"
                                                            {{ is_array(old('tujuan')) && in_array($jabatan->id, old('tujuan')) ? 'selected' : '' }}>
                                                                {{ $jabatan->nama_jabatan }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="perihal" id="summernote_perihal" class="form-control">{{ old('perihal') }}</textarea>
                                        </div>
                                        <!-- Isi Surat -->
                                        <div class="form-group">
                                            <label for="summernote_isi">Isi Surat</label>
                                            <textarea name="isi_surat" id="summernote_isi" class="form-control">{{ old('isi_surat') }}</textarea>
                                        </div>
                                    </div>
                                    <!-- Card Footer -->
