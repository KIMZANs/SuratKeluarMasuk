...
return new class extends Migration {
    ...
    {
        Schema::create('tembusan_suratkeluar', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::table('tembusan_suratkeluar', function (Blueprint $table) {
            $table->dropForeign(['surat_keluar_id']);
            $table->dropForeign(['jabatan_id']);
            $table->dropForeign(['unit_kerja_id']);
        });

        Schema::dropIfExists('tembusan_suratkeluar');
    }
};
